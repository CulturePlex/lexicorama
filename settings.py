...
DATABASES = {
    'default': {
        ...
        'NAME': 'lexicorama',            # Or path to database file if using sqlite3.
        'USER': 'lexicorama',                      # Not used with sqlite3.
...
SECRET_KEY = '9s-jun/aH987789¿¿¡d]@ç13fgh89Ujuh-*/4584*nttqq_pr6'
...
# API Keys
GOOGLE_ANALYTICS_CODE = u"UA-1613313-10"
